...
impl Camera {
	pub fn new(image_width: u32, aspect_ratio: f64, vfov: f64, samples_per_pixel: u32, max_depth: u32, look_from: Point3, look_at: Point3, vup: Vec3) -> Camera {
		...
		let focal_length: f64 = (look_from - look_at).length();
